...
class t_rr_node {
  ...
  public: //Accessors
    ...
    std::string to_pin_type() const;

    short to_pin_num() const;

    bool is_bend_first() const;
    bool is_bend_end() const;
    bool is_medium_node() const;
  ...
  public: //Mutators
    ...
    void set_seg_id(short seg_id);
    //void set_medium_id(short medium_id);
    ...
    void set_to_pin_type(std::string);
    void set_to_pin_num(short);

    void set_bend_first_node(bool);
    void set_bend_end_node(bool);

    void set_medium_node(bool);
  ...
  private: //Data
    ...
    std::string to_pin_type_;
    int16_t to_pin_num_;

    bool is_bend_first_node = false;
    bool is_bend_end_node = true;

    bool medium_node = false;
};
