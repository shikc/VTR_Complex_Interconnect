...
void try_graph(int width_fac, t_router_opts router_opts, const t_arch* arch, t_det_routing_arch* det_routing_arch, std::vector<t_segment_inf>& segment_inf, t_chan_width_dist chan_width_dist, t_direct_inf* directs, int num_directs, t_detailInterConnect_inf* detailICs, int num_detailics) {
