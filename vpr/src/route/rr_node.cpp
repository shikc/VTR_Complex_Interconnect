...
short t_rr_node::seg_id() const {
    return seg_id_;
}
/*
short t_rr_node::medium_id() const {
    return medium_id_;
}*/
...
bool t_rr_node::is_bend_end() const {
    return is_bend_end_node;
}

bool t_rr_node::is_medium_node() const {
    return medium_node;
}
...
void t_rr_node::set_seg_id(short seg_id){
    seg_id_ = seg_id;
}
/*
void t_rr_node::set_medium_id(short medium_id) {
    medium_id_ = medium_id;
}*/
...
void t_rr_node::set_bend_end_node(bool is_bend_end) {
    is_bend_end_node = is_bend_end;
}

void t_rr_node::set_medium_node(bool is_medium_node){
    medium_node = is_medium_node;
}
...
void t_rr_node::set_to_pin_type(std::string to_pin_type){
    to_pin_type_=to_pin_type;
}

void t_rr_node::set_to_pin_num(short to_pin_num){
    to_pin_num_=to_pin_num;
}

short t_rr_node::to_pin_num() const{
    return to_pin_num_;
}

std::string t_rr_node::to_pin_type() const{
    return to_pin_type_;
}