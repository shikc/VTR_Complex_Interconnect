...
void try_place(t_placer_opts placer_opts,
    ...
    if (placer_opts.place_algorithm == PATH_TIMING_DRIVEN_PLACE
        ...
        place_delay_model = alloc_lookups_and_criticalities(chan_width_dist, placer_opts, router_opts, arch, det_routing_arch, segment_inf, directs, num_directs, detailICs, num_detailics);
