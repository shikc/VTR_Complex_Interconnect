...
RouteStatus vpr_route_fixed_W(t_vpr_setup& vpr_setup,
    ...
    bool status = try_route(fixed_channel_width,
                            ...
                            arch.DetailICs, arch.num_detailics,
...
void free_device(const t_det_routing_arch& routing_arch) {
    ...
    device_ctx.normal_chan_width.x_list.clear();
    device_ctx.normal_chan_width.y_list.clear();
    device_ctx.normal_chan_width.max = device_ctx.normal_chan_width.x_max = device_ctx.normal_chan_width.y_max = device_ctx.normal_chan_width.x_min = device_ctx.normal_chan_width.y_min = 0;
